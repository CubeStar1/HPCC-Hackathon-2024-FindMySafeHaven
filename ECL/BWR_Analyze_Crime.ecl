...
// CRIME Analysis by county
Crime_by_county := CrimeDS(attribute = 'POP_ESTIMATE_2020' 
...
OUTPUT(Population_by_county_tbl,,'~AVI::OUT::POP', OVERWRITE);
...
OUTPUT(Population_by_county_Norm,,'~AVI::OUT::POPNORM', OVERWRITE);